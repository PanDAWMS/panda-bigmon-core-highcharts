#!/usr/bin/env python
#
# Setup prog for twdev-bigpandamon-core-highcharts
#
#
...
setup(
    name=__provides__,
    version=__version__,
    description='BigPanDA Monitoring Package - Highcharts component',
    long_description='''This package contains BigPanDA Monitoring Components - Highcharts''',
    license='GPL',
    author='Panda Team',
